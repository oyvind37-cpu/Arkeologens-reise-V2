...
/* ---------- AURORA MOTION SYSTEM v5.8.0 / ARTICULATED 2D RIG ----------
   v5.8 keeps Aurora's approved visual model, but splits the character into six
   articulated image layers. Arms, legs, head and torso can now move separately,
   so walking and interactions no longer read as one flat card sliding sideways. */
let mainVelocity=0;
